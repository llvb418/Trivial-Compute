...
urlpatterns = [
    ...
    path('award-chip/<int:session_id>/<int:player_id>/', views.award_chip, name='award-chip'),
    path('update-position/<int:session_id>/<int:player_id>/', views.update_position, name='update-position'),
